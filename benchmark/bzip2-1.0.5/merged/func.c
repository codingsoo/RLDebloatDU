...
struct __anonstruct_bz_stream_26 {   char *next_in;   unsigned int avail_in;   unsigned int total_in_lo32;   unsigned int total_in_hi32;   char *next_out;   unsigned int avail_out;   unsigned int total_out_lo32;   unsigned int total_out_hi32;   void *state;   void *(*bzalloc)(void *, int, int);   void (*bzfree)(void *, void *);   void *opaque; };
typedef struct __anonstruct_bz_stream_26 bz_stream;
typedef unsigned int UInt32;
typedef unsigned short UInt16;
struct __anonstruct_DState_28 {   bz_stream *strm;   Int32 state;   UChar state_out_ch;   Int32 state_out_len;   Bool blockRandomised;   Int32 rNToGo;   Int32 rTPos;   UInt32 bsBuff;   Int32 bsLive;   Int32 blockSize100k;   Bool smallDecompress;   Int32 currBlockNo;   Int32 verbosity;   Int32 origPtr;   UInt32 tPos;   Int32 k0;   Int32 unzftab[256];   Int32 nblock_used;   Int32 cftab[257];   Int32 cftabCopy[257];   UInt32 *tt;   UInt16 *ll16;   UChar *ll4;   UInt32 storedBlockCRC;   UInt32 storedCombinedCRC;   UInt32 calculatedBlockCRC;   UInt32 calculatedCombinedCRC;   Int32 nInUse;   Bool inUse[256];   Bool inUse16[16];   UChar seqToUnseq[256];   UChar mtfa[4096];   Int32 mtfbase[16];   UChar selector[18002];   UChar selectorMtf[18002];   UChar len[6][258];   Int32 limit[6][258];   Int32 base[6][258];   Int32 perm[6][258];   Int32 minLens[6];   Int32 save_i;   Int32 save_j;   Int32 save_t;   Int32 save_alphaSize;   Int32 save_nGroups;   Int32 save_nSelectors;   Int32 save_EOB;   Int32 save_groupNo;   Int32 save_groupPos;   Int32 save_nextSym;   Int32 save_nblockMAX;   Int32 save_nblock;   Int32 save_es;   Int32 save_N;   Int32 save_curr;   Int32 save_zt;   Int32 save_zn;   Int32 save_zvec;   Int32 save_zj;   Int32 save_gSel;   Int32 save_gMinlen;   Int32 *save_gLimit;   Int32 *save_gBase;   Int32 *save_gPerm; };
typedef struct __anonstruct_DState_28 DState;
struct __anonstruct_EState_27 {   bz_stream *strm;   Int32 mode;   Int32 state;   UInt32 avail_in_expect;   UInt32 *arr1;   UInt32 *arr2;   UInt32 *ftab;   Int32 origPtr;   UInt32 *ptr;   UChar *block;   UInt16 *mtfv;   UChar *zbits;   Int32 workFactor;   UInt32 state_in_ch;   Int32 state_in_len;   Int32 rNToGo;   Int32 rTPos;   Int32 nblock;   Int32 nblockMAX;   Int32 numZ;   Int32 state_out_pos;   Int32 nInUse;   Bool inUse[256];   UChar unseqToSeq[256];   UInt32 bsBuff;   Int32 bsLive;   UInt32 blockCRC;   UInt32 combinedCRC;   Int32 verbosity;   Int32 blockNo;   Int32 blockSize100k;   Int32 nMTF;   Int32 mtfFreq[258];   UChar selector[18002];   UChar selectorMtf[18002];   UChar len[6][258];   Int32 code[6][258];   Int32 rfreq[6][258];   UInt32 len_pack[258][4]; };
typedef struct __anonstruct_EState_27 EState;
typedef void BZFILE;
typedef char Char;
struct __anonstruct_bzFile_29 {   FILE *handle;   Char buf[5000];   Int32 bufN;   Bool writing;   bz_stream strm;   Int32 lastErr;   Bool initialisedOk; };
...
struct __anonstruct_UInt64_56 {   UChar b[8]; };
typedef struct __anonstruct_UInt64_56 UInt64;
struct zzzz {   Char *name;   struct zzzz *link; };
...
;
if (s->verbosity >= 3) {
fprintf((FILE *  ) stderr,                     (char const *  ) "      pass %d: size is "                                                      "%d, grp uses are ",                     iter + 1, totc / 8);
t = 0;
;
fprintf((FILE *  ) stderr,                     (char const *  ) "\n");
}
...
;
if (s->verbosity >= 3) {
fprintf((FILE *  ) stderr,                 (char const *  ) "      bytes: mapping %d, ",                 s->numZ - nBytes);
}
nBytes = s->numZ;
...
;
if (s->verbosity >= 3) {
fprintf((FILE *  ) stderr,                 (char const *  ) "selectors %d, ",                 s->numZ - nBytes);
}
nBytes = s->numZ;
t = 0;
while (1) {
...
;
if (s->verbosity >= 3) {
fprintf((FILE *  ) stderr,                 (char const *  ) "code lengths %d, ",                 s->numZ - nBytes);
}
nBytes = s->numZ;
selCtr = 0;
gs = 0;
...
if (s->verbosity >= 3) {
fprintf((FILE *  ) stderr,                           (char const *  ) " {0x%08x, 0x%08x}",                           s->storedBlockCRC, s->calculatedBlockCRC);
}
if (s->verbosity >= 2) {
fprintf((FILE *  ) stderr,                           (char const *  ) "]");
}
...
n2 = (Int32)fwrite(                 (void const *  )((void *)(bzf->buf)),                 sizeof(UChar), (size_t)n,                 (FILE *  ) bzf->handle);
}
...
_L:
if (nread > 0) {
fwrite((void const *  )(obuf),                            sizeof(UChar), (size_t)nread,                            (FILE *  ) stream);
}
}
}
...
BZ2_bzReadClose(&bzerr_dummy, bzf);
if (verbosity == 0) {
fprintf((FILE *  ) stderr,                 (char const *  ) "%s: %s: ", progName, inName);
}
if (bzerr == -5) {
goto case_neg_5;
}
...
;
if (verbosity >= 1) {
fprintf((FILE *  ) stderr,                 (char const *  ) "  %s: ", inName);
fflush(stderr);
}
...
if (tmp___11 == 0) {
fprintf(                                                   (FILE *  )                                                       stderr,                                                   (char const                                                        *  ) "%s"                                                                             ": "                                                                             "Ba"                                                                             "d "                                                                             "fl"                                                                             "ag"                                                                             " `"                                                                             "%s"                                                                             "\'"                                                                             "\n",                                                   progName, aa->name);
exit(1);
}
}
}
...
;
if (verb >= 4) {
fprintf((FILE *  ) stderr,                     (char const *  ) "        depth %6d has ",                     H);
}
j = 0;
i = 0;
while (1) {
