...
__inline static void bsW(EState *s,
                        Int32 n,
                        UInt32 v) {
while (1) {
while_continue:
...
static void compressStream(FILE *stream,
                        FILE *zStream) {
BZFILE *bzf;
UChar ibuf[5000];
Int32 nIbuf;
...
static Bool uncompressStream(FILE *zStream,
                        FILE *stream) {
BZFILE *bzf;
Int32 bzerr;
Int32 nread;
...
__inline static Bool mainGtU(UInt32 i1,
                        UInt32 i2,
                        UChar *block,
                                                     UInt16 *quadrant,
                        UInt32 nblock,
...
__inline static UChar mmed3(UChar a,
                        UChar b,
                        UChar c) {
return (b);
}
